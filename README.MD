...
- **BrowserHistory**: Extrae historial de navegadores web (Chrome) y además permite enviarlos por un segundo canal de salida (por ejemplo otro índice de elasticsearch, u otro fichero distinto al del análisis) 
